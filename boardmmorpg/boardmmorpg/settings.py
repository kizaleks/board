"""
Django settings for boardmmorpg project.
...
SECRET_KEY = 'django-insecure-k7@hzdl9n(s&6^%m4z+c47jfd5x40cmf)l8&6tfsq_1^^ih*da'
...
WSGI_APPLICATION = 'boardmmorpg.wsgi.application'
